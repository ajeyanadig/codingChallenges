...
const init = ()=>{
    ...
    (0, _searchViewJsDefault.default).addHanlderSearch(controlSeachResults);
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.search.page = 1, state.search.results = data.data.recipes.map((rec)=>{
            return {
                id: rec.id,
                image: rec.image_url,
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error("Wrong ingredient format. Please use correct format (quantity,unit,description )");
...
const KEY = "fade4ab7-0481-4db1-8793-5e8c2f670034";
const MODAL_CLOSE_SEC = 2.5; // API for search recipes
 // https://forkify-api.herokuapp.com/api/v2/recipes?search=pizza
 //API KEY fade4ab7-0481-4db1-8793-5e8c2f670034
...
},{"../../img/icons.svg":"cMpiy","fracty":"hJO4d","./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cMpiy":[function(require,module,exports) {
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        return this._data.map((result)=>(0, _previewViewDefault.default).render(result, false)).join(""); //callback(curr,i,arr)
    }
}
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        //console.log(this._data);
        return this._data.map((bookmark)=>(0, _previewViewDefault.default).render(bookmark, false)).join(""); //callback(curr,i,arr)
    }
}
exports.default = new ResultsView();

},{"./View":"5cUXS","../../img/icons.svg":"cMpiy","./previewView":"1FDQ6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYpTN","aenu9"], "aenu9", "parcelRequire3a11")
